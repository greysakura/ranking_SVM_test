...
/* 2014/09/26 I guess this is our loss function. */

/* This is only the loss for each term. */
double      loss(LABEL y, LABEL ybar, STRUCT_LEARN_PARM *sparm)
{
  ...
  if(sparm->loss_function == SWAPPEDPAIRS) {
    if(ybar.loss >= 0)
      loss=ybar.loss;            /* during training loss is provided by fmvc */
        ...
        /* Compute total number of swapped pairs. */
  ...
  else if(sparm->loss_function == INVERSIONLOSS){
